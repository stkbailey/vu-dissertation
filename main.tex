...
\begin{center}
	...
	\textsc{Doctor of Philosophy} \\[.1in]
	in \\[.2in]
...
\hspace*{1.0in} Approved: \hskip 2.4in Date:\\[1em]
% \hspace*{1.0in} \rule{3.0in}{.5pt} \hskip 0.1in \rule{1in}{.5pt} \\[.1in]
% \hspace*{1.0in} \rule{3.0in}{.5pt} \hskip 0.1in \rule{1in}{.5pt} \\[.1in]
% \hspace*{1.0in} \rule{3.0in}{.5pt} \hskip 0.1in \rule{1in}{.5pt} \\[.1in]
% \hspace*{1.0in} \rule{3.0in}{.5pt} \hskip 0.1in \rule{1in}{.5pt} %\\[.1in]

\hspace*{0.75in} \tline{Professor Adam Anderson \hspace*{1.6in}}{3.0in} \hskip 0.1in  \tline{}{1.0in} \\[.25in]
\hspace*{1.0in} \tline{Professor Laurie Cutting \hspace*{1.7in}}{3.0in} \hskip 0.1in  \tline{}{1.0in} \\[.25in]
\hspace*{1.0in} \tline{Professor Zhaohua Ding \hspace*{1.71in}}{3.0in} \hskip 0.1in \tline{}{1.0in} \\[.25in]
\hspace*{1.0in} \tline{Professor Gavin Price \hspace*{1.83in}}{3.0in} \hskip 0.1in \tline{}{1.0in} 
