...
\begin{figure}[t]
	\centering
	\includegraphics[width=4in]{ch3-activation-vs-participation}
...
We found that nodes that were more activated in reading relative to rest tended to be those which were not hub-like. In fact, those areas that were most hub-like tended to show the least ``activity'' from a univariate standpoint. 
