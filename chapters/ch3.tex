...
It makes sense: the areas that are increasing in participation coefficients are on the ``periphery'' of each RSN - but they are present in roughly equal proportions across all RSNs.  
