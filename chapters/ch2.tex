...
\begin{figure}[t]
	\centering
	\includegraphics[]{ch2-passages-activation-attn}
...
\begin{figure}[t]
	\centering
	\includegraphics[]{ch2-listening-reading-connectome-activations}
    \caption[There is significant overlap between the areas used in listening and reading.]{A widespread set of brain areas are utilized during listening and reading, including auditory, default mode and attention areas.}
...
\begin{figure}[b]
	\centering
	\includegraphics[]{ch2-modality-graph-theory}
...
\begin{figure}[b]
	\centering
	\includegraphics[]{ch2-comprehension-reorganization}
...
\begin{figure}[b]
	\centering
	\includegraphics[]{ch2-modality-reorganization}
