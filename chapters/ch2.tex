...
We demonstrate that the relative position of each each these distribution of these measures across our sample at a threshold retaining the top 10 percent of connections, and across multiple thresholds. 
