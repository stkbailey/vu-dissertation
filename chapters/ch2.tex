...
\begin{figure}[t]
	\centering
	\includegraphics[height=5in]{images/ch2-price-language-models.jpg}
...
In this study, I pursue three hypothesized ways reading might differ from listening. These are not exclusive; one or more of them may be true. The overarching aim is to test whether reading is simply listening skills
...
We tested three hypotheses related to the involvement of sensory, attention and executive regions. 
